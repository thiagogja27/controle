      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-7">
        <div className="lg:col-span-4 grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="grid gap-4">
            ...
            <CardTitle className="text-sm font-medium">Empresas de Hoje</CardTitle><Building className="h-4 w-4 text-muted-foreground" /></CardHeader><CardContent><div className="text-2xl font-bold">{stats.empresasDeHoje}</div><p className="text-xs text-muted-foreground">Empresas a(s) qual(is) os visitantes pertencem.</p></CardContent></Card>
          </div>
        </div>
